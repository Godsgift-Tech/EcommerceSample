...
{
    /// <inheritdoc />
    public partial class EcommerceDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityDemanded = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderProduct", x => new { x.ProductOrderId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_OrderProduct_Orders_ProductOrderId",
